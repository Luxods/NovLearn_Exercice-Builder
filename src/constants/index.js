...
export const elementTypes = [
  ...
  { type: 'variationTable', label: 'Tableau de variations', icon: '📋', chapters: 'all' },
  { type: 'signTable', label: 'Tableau de signes', icon: '±', chapters: 'all' },
  { type: 'probaTree', label: 'Arbre de probabilité', icon: '🌳', chapters: 'all' },
  { type: 'sequence', label: 'Suite', icon: '🔢', chapters: 'all' },
  { type: 'discreteGraph', label: 'Graphe Discret', icon: '📊', chapters: 'all' },
  { type: 'complexPlane', label: 'Plan complexe', icon: '🔷', chapters: 'all' },
  { type: 'vector', label: 'Vecteur', icon: '➡️', chapters: 'all' },
  { type: 'statsTable', label: 'Tableau statistique', icon: '📊', chapters: 'all' },
